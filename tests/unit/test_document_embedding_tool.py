"""Unit tests for the generate_document_embedding MCP tool (mocked vector DB
and embedding service). See tests/integration/test_document_embedding_tool.py
for the tests that boot real services via the `real_services` fixture."""
